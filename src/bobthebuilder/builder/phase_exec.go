...
func (p * ScriptExecPhase)init(index int){
  p.Type = "SCRIPT-EXEC"
...
func (p * ScriptExecPhase)Run(r* Run, builder *Builder, defIndex int)int{
  p.Start = time.Now()
...
func (p * ScriptExecPhase)Write(in []byte)(n int, err error){
